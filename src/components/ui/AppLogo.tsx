...
function BookletMark({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      {/* The page — a rounded rect with its top-right corner folded down,
          the one signature detail (mirrors the paper-tab on the marketing
          page's before/after comparison): a page worth flagging. */}
      <path
