...
const SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  ...
  <path d="M324.3 106.7L373.3 155.7H341.3C332.0 155.7 324.3 148.1 324.3 138.7V106.7Z" fill="#a12f3e"/>
  <rect x="185.6" y="204.8" width="147.2" height="32" rx="16" fill="#a12f3e" fill-opacity="0.85"/>
  <rect x="185.6" y="268.8" width="98.1" height="32" rx="16" fill="#a12f3e" fill-opacity="0.55"/>
</svg>`;
