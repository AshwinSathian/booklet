...
export const THEMES: Theme[] = [
  {
    id: "default",
    name: "Signature",
    description: "The default Booklet palette — ink accent, pure-black dark mode, Apple-white light mode.",
    swatch: "#a12f3e",
    dark: {
      "--color-bg": "#000000",
      ...
      "--color-accent-soft": "#e5808a",
      "--color-accent-dim": "rgba(161, 47, 62, 0.14)",
